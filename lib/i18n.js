...
export const STRINGS = {
  ko: {
    ...
    tile_btk: "BTK", tile_ttk: "TTK(초)", tile_overkill: "오버킬", tile_reloads: "재장전 횟수", tile_magpct: "탄창 소모", tile_killspermag: "탄창당 처치",
  ...
  en: {
    ...
    tile_btk: "BTK", tile_ttk: "TTK(s)", tile_overkill: "Overkill", tile_reloads: "Reloads", tile_magpct: "Mag used", tile_killspermag: "Kills/mag",
