...
export const STRINGS = {
  ko: {
    ...
    stat_dps: "초당 피해(DPS)", stat_fireduration: "완전 연사 지속시간(초)",
    ...
    killpath_title: "킬 경로 순위 — 이 무기로 이 적을 잡는 방법", killpath_none: "이 무기로는 관통 가능한 처치 경로를 찾지 못했습니다.",
    killpath_col_rank: "순위", killpath_col_route: "경로", killpath_col_note: "비고",
    killpath_general_label: "일반", killpath_seconds_suffix: "초",
    killpath_precision_badge: "정밀 조준 필요",
    killpath_general_caption: "⚠ 부위 하나에만 맞는다고 가정한 보수적 추정치입니다. 원뿔형/스플래시로 나가는 무기는 여러 부위에 동시에 맞아 실제로는 더 빠를 수 있습니다 (검증된 배수 없음).",
    killpath_partstable_summary: "동시 명중 부위 수별 예상 시간 보기",
    killpath_parts_suffix: "개 부위 동시 명중",
    killpath_recommended_tag: "← 가정(75%)",
  ...
  en: {
    ...
    stat_dps: "Damage per second (DPS)", stat_fireduration: "Continuous fire duration (s)",
    ...
    killpath_title: "Kill Path Ranking — how to take this target down with this weapon", killpath_none: "No path that can penetrate this target was found with this weapon.",
    killpath_col_rank: "Rank", killpath_col_route: "Route", killpath_col_note: "Note",
    killpath_general_label: "general", killpath_seconds_suffix: "s",
    killpath_precision_badge: "Precision aim required",
    killpath_general_caption: "⚠ Conservative estimate assuming only one part is hit. Cone/splash weapons may hit several parts at once and be faster in practice (no verified multiplier).",
    killpath_partstable_summary: "See estimated time by number of parts hit at once",
    killpath_parts_suffix: " parts hit at once",
    killpath_recommended_tag: "← assumed (75%)",
